...
class StripeService {
  ...
  static String secret =
      'sk_test_51JEMxwKoBvgXHaG7iMy1mMpSqMJP6cklb3d7UtRB4c5wE7szQkNWrTxla8G9rzZdqoum9lCZbqdKq2IIcNbIUGT800dQTgQ7NX';
  ...
  static init() {
    StripePayment.setOptions(StripeOptions(
        publishableKey:
            'pk_test_51JEMxwKoBvgXHaG7McipVqh5ITFk8YRvBSHhaVPFwYilg79IscSGAHxN8nkAvbwHv6nw6uEOPWOxjmhLIJgfevWE00ZfqbEurY',
        merchantId: 'test',
        androidPayMode: 'test'));
  }
